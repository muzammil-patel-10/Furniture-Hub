...
if(isset($_POST['submit'])){
	...
	mysqli_query($con,"insert into `order`(user_id,address,city,pincode,payment_type,payment_status,order_status,added_on,total_price,txnid,mihpayid,payu_status) values('$user_id','$address','$city','$pincode','$payment_type','$payment_status','$order_status','$added_on','$total_price','$txnid','','')");
	...
	foreach($_SESSION['cart'] as $key=>$val){
		...
		$sql="select qty from product where id='$key'";
		$res=mysqli_query($con,$sql);
		$result=mysqli_fetch_assoc($res);
		$newqty=$result['qty'];
		$updateqty=$newqty-$qty;
		mysqli_query($con,"update product set qty='$updateqty' where id='$key'");
	}
                                ...
                                <div class="accordion">
									...
									<form method="post">
										...
										<div class="accordion__body">
										 ...
										 <input type="submit"class="fr__btn" name="submit"/>
									</form>
                                </div>
                            </div>
                        </div>
